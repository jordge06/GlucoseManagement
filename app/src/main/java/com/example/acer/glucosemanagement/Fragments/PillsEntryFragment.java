...
public class PillsEntryFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_pills, container, false);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btnAddPillEntry) {
            ...
            if (isNotEmpty()) {
                iMainInterface.savePillEntries2(pillsCategoryList);
            }
